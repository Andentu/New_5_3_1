namespace New_5_3_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 4. Передача  с использованием out
            // Этот модификатор значит, что параметр является выходным, то есть его значение является результатом работы метода.
            string surname; // При использовании out можно не задавать начальное значение переменной
            GetSurname(out surname);
            Console.WriteLine("Ваша фамилия: " + surname); // Исходные данные изменяются
        ...
        // Для передаче с использованием out (можно передавать пустое значение, а добавить уже в методе)
        static void GetSurname (out string LastName)
        {
